...
extern void hf_joel_loop();
const BehaviorScript bhvHfJoel[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_LONG(oFlags, (OBJ_FLAG_SET_FACE_ANGLE_TO_MOVE_ANGLE | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(hf_joel_collision),
    SET_FLOAT(oDrawingDistance, 20000),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(hf_joel_loop),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};
...
extern const Collision bdf_pusher_collision[];
...
const BehaviorScript bhvBowserMetalBoxPush[] = {
    ...
    LOAD_COLLISION_DATA(bdf_pusher_collision),
    SET_HOME(),
    BEGIN_LOOP(),
...
const BehaviorScript bhvSlideCheckpointCtl[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    CALL_NATIVE(slide_checkpoint_ctl_init),
    BEGIN_LOOP(),
        CALL_NATIVE(slide_checkpoint_ctl_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvAgtGear2[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(gear_2_collision),
    OR_INT(oFlags, (OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INT(oAngleVelYaw, -100),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_rotating_octagonal_plat_loop),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
...
const BehaviorScript bhvAgtGear3[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(gear_3_collision),
    OR_INT(oFlags, (OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INT(oAngleVelPitch, 100),
    BEGIN_LOOP(),
        ADD_INT(oFaceAnglePitch, 100),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};

const BehaviorScript bhvAgtGear4[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(gear_4_collision),
    OR_INT(oFlags, (OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INT(oAngleVelYaw, -100),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_rotating_octagonal_plat_loop),
...
const BehaviorScript bhvDnvicColorReset[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    CALL_NATIVE(bhv_dnvic_color_reset_init),
    SET_HOME(),
    BEGIN_LOOP(),
...
extern void bhv_luigiman_bullet_bill_init();
extern void bhv_luigiman_bullet_bill_loop();
const BehaviorScript bhvLuigimanBulletBill[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_MOVE_XZ_USING_FVEL | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 50, /*Downwards offset*/ 50),
    ...
    SET_INT(oIntangibleTimer, 0),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ 0, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    CALL_NATIVE(bhv_luigiman_bullet_bill_init),
    BEGIN_LOOP(),
